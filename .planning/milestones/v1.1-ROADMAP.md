...
- [x] **Phase 6: apps/web Integration** - Contacts/Demo submissions and Blog/Prices content go live on real data (completed 2026-08-15)
- [x] **Phase 06.1: Premium Visual Restyle (apps/web)** *(inserted)* - premium `dt-` token restyle of every page (completed 2026-08-18)
- [x] **Phase 06.2: Single-Page Landing Consolidation + i18n (apps/web)** *(inserted)* - one scrolling landing page + uk/ru/en locale routing (completed 2026-08-19)
...
| 6. apps/web Integration | 3/3 | Complete | 2026-08-15 |
